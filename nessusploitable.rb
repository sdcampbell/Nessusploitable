...
OptionParser.new do |opts|
  ...
  opts.on('-h', '--help', "Prints help") do
    puts "Ruby Nessus - Parses Nessus .nessus files for exploitable vulnerabilities and prints to stdout or outputs a report file in TSV format for Excel"
